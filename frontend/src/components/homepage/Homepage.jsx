...
const Homepage = () => {
  return (
    <section className='h-dvh grid grid-flow-row place-items-center px-10 content pb-10'>
      <div className='xl:w-[1240px] w-full'>
        <Nav/>
        <div className='w-full flex flex-col gap-4'>
            <img src={bigPoster} alt=""  className='w-full hidden sm:block'/>
            <img src={doctors} alt=""  className='sm:hidden'/>
          ...
          <div className='border-2 flex flex-col items-center p-3 gap-2 rounded-md'>
              <div className='flex gap-4 py-2 items-center w-fit border-b-2 '>
                  ...
                  <div className='border-e-2 pr-2'><p className='text-gray-700 text-sm'> specialist</p></div>
                  <p className='text-gray-700 text-sm'>12 years experience</p>
                  </div>
                  <div className='w-fit'>
                  <p className='text-iconblue bg-teal-50 text-sm p-1 rounded-xl'>Padiatric</p>
                  </div>
              </div>
              </div>
              ...
              <div className='border-r-2 px-4'>
                  ...
                  <p className='ml-6 text-gray-700 text-sm'>10:00 AM-01:00 PM</p>
              </div>
              <div>
              ...
              <button className='btn text-md w-full'>Book an appointment</button>
