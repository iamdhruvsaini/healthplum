  ...
  const generateDates = () => {
    ...
    for (let i = 0; i < 10; i++) {
      ...
      const formattedDate = {
        ...
        short: date.toLocaleDateString('en-US', { weekday: 'short', day: 'numeric' }),
        ...
        <div className="p-4 md:p-6">
          ...
          {currentStep === 1 && (
            <div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
                  {generateDates().map((date, index) => (
                    ...
                    >
                      ...
                      <p className={`font-medium ${formValues.selectedDate === date.value ? 'text-blue-600' : 'text-gray-800'}`}>
                        {date.value.split('-')[2]}
                      </p>
                    </label>
                  ))}
                </div>
                {errors.selectedDate && <p className="text-red-500 text-sm mt-2">{errors.selectedDate.message}</p>}
              </div>
              ...
              <div className="mb-6">
                ...
                {errors.selectedTime && <p className="text-red-500 text-sm mt-2">{errors.selectedTime.message}</p>}
              </div>
            </div>
          )}
          ...
          {currentStep === 2 && (
            <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {appointmentTypes.map((type, index) => (
                    ...
                    >
                      ...
                      />
                      <p className={`font-medium ${formValues.appointmentType === type ? 'text-blue-600' : 'text-gray-800'}`}>{type}</p>
                    </label>
                  ))}
                </div>
              ...
              <div className="mb-6">
                <h3 className="text-lg font-semibold text-gray-800 mb-4">Reason for Visit</h3>
                <textarea
                  className={`w-full p-4 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${errors.appointmentReason ? 'border-red-500' : ''}`}
                  rows="4"
                ...
                ></textarea>
                {errors.appointmentReason && <p className="text-red-500 text-sm mt-2">{errors.appointmentReason.message}</p>}
              </div>
                ...
                {formValues.isInsurance === 'true' && (
                  <div className="space-y-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-gray-700 text-sm font-medium mb-1">Insurance Provider</label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label className="block text-gray-700 text-sm font-medium mb-1">Insurance ID</label>
                        <input
                          type="text"
                    ...
                    <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
                      <p className="text-sm text-gray-600 flex items-start">
                        ...
                        Please bring your insurance card to your appointment. We will verify your coverage before your visit.
                      </p>
                    </div>
                  </div>
                )}
          ...
          {currentStep === 3 && (
            <div>
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 gap-4">
                  <div>
                    ...
                    <input
                      type="text"
                      className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${errors.patientName ? 'border-red-500' : 'border-gray-300'}`}
                  ...
                  <div>
                    ...
                    <input
                      type="email"
                      className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${errors.patientEmail ? 'border-red-500' : 'border-gray-300'}`}
                    ...
                    />
                    {errors.patientEmail && <p className="text-red-500 text-sm mt-1">{errors.patientEmail.message}</p>}
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      type="tel"
                      className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${errors.patientPhone ? 'border-red-500' : 'border-gray-300'}`}
              ...
              <div className="p-4 bg-blue-50 rounded-lg border border-blue-100">
                <p className="text-sm text-gray-600 flex items-start">
                  <AlertCircle className="h-5 w-5 mr-2 text-blue-600 flex-shrink-0" />
                  By scheduling this appointment, you agree to our cancellation policy. Please arrive 15 minutes before your appointment time.
                </p>
              </div>
            </div>
          )}
          ...
          {currentStep === 4 && (
            <div className="text-center py-6">
              ...
              <p className="text-gray-600 mb-8">Your appointment has been scheduled successfully.</p>
                ...
                <div className="space-y-4">
                  <div className="flex">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-800">
                        {formValues.selectedDate ? new Date(formValues.selectedDate).toLocaleDateString('en-US', { weekday: 'long', month: 'long', day: 'numeric' }) : ''}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-800">{formValues.selectedTime}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-800">{formValues.appointmentType}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-800">{formValues.patientName}</p>
                    </div>
                  </div>
          ...
          <div className="px-4 md:px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-between">
            ...
            {currentStep < 3 ? (
              <button 
                ...
                disabled={
                  (currentStep === 1 && (!formValues.selectedDate || !formValues.selectedTime)) ||
                  (currentStep === 2 && (!formValues.appointmentType || !formValues.appointmentReason))
                }
              >
                Continue
